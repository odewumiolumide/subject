...
<!-- Mirrored from www.on3-step.com/tf/luxury/html/service-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 11:05:12 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <nav id="menu-center">
              <ul>
                ...
                <ul>
                 ...
                 <li><a class="actived" href="#">Services <i class="fa fa-angle-down"></i></a>
                  <ul>
 ...
 <!-- room -->      
 <section class="whitepage" aria-label="rooms">
  <div class="container">
   <div class="row">
   
   <div class="col-md-6">
    <div class="room">
     <img class="img-responsive" alt="room img" src="img/rooms/img1.jpg">
     <div class="heading">Luxury Single Room</div>
     <div class="devider-rooms"></div>
     <div class="price">$280<sub>/ night</sub></div>
     <p class="content">Voluptatem accusantium doloremque totam rem aperiam, laudantium eaque ipsa quae ab illo inventore veritatis explicabo.</p>
     <div class="btn-book"><a href="room-detail.html">VIEW MORE</a></div>
    </div>
   </div>
   
   <div class="col-md-6">
   <div class="room">
   <img class="img-responsive" alt="room img" src="img/rooms/img2.jpg">
   <div class="heading">Luxury Double Room </div>
     <div class="devider-rooms"></div>
     <div class="price">$400<sub>/ night</sub></div>
     <p class="content">Voluptatem accusantium doloremque totam rem aperiam, laudantium eaque ipsa quae ab illo inventore veritatis explicabo.</p>
     <div class="btn-book"><a href="room-detail2.html">VIEW MORE</a></div>
   </div>
   </div>
   
   <div class="col-md-6">
   <div class="room">
   <img class="img-responsive" alt="room img" src="img/rooms/img3.jpg">
   <div class="heading">Luxury Premium Room </div>
     <div class="devider-rooms"></div>
     <div class="price">$550<sub>/ night</sub></div>
     <p class="content">Voluptatem accusantium doloremque totam rem aperiam, laudantium eaque ipsa quae ab illo inventore veritatis explicabo.</p>
     <div class="btn-book"><a href="room-detail3.html">VIEW MORE</a></div>
   </div>
   </div>
   ...
   <div class="col-md-6">
    <div class="room">
     <img class="img-responsive" alt="room img" src="img/rooms/img1.jpg">
     <div class="heading">LUXURY Premium Room 2</div>
     <div class="devider-rooms"></div>
     <div class="price">$620<sub>/ night</sub></div>
     <p class="content">Voluptatem accusantium doloremque totam rem aperiam, laudantium eaque ipsa quae ab illo inventore veritatis explicabo.</p>
     <div class="btn-book"><a href="room-detail4.html">VIEW MORE</a></div>
    </div>
   </div>
   ...
   <div class="room">
   <img class="img-responsive" alt="room img" src="img/rooms/img2.jpg">
   <div class="heading">Luxury SUITE Room </div>
     <div class="devider-rooms"></div>
     <div class="price">$675<sub>/ night</sub></div>
     <p class="content">Voluptatem accusantium doloremque totam rem aperiam, laudantium eaque ipsa quae ab illo inventore veritatis explicabo.</p>
     <div class="btn-book"><a href="room-detail5.html">VIEW MORE</a></div>
   </div>
   </div>
   ...
   <div class="room">
   <img class="img-responsive" alt="room img" src="img/rooms/img3.jpg">
   <div class="heading">Luxury MASTER Bedroom </div>
     <div class="devider-rooms"></div>
     <div class="price">$720<sub>/ night</sub></div>
     <p class="content">Voluptatem accusantium doloremque totam rem aperiam, laudantium eaque ipsa quae ab illo inventore veritatis explicabo.</p>
     <div class="btn-book"><a href="room-detail6.html">VIEW MORE</a></div>
   </div>
   </div>
